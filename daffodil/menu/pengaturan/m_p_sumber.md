...
| Jenis Koneksi  | jenis protokol yang digunakan.<br> **Modbus RTU / Modbus TCP**                                                                                                            |
| ID Slave       | id slave dari prangkat yang terkoneksi                                                                                                                                    |

##### PARAMETER DATA YANG DI AMBIL
...
- Apabila ingin menambah lagi di **Device** yang sama, pengguna bisa tambahkan lagi parameter dengan konfigurasi parameter seperti diatas.
