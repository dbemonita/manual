...
| ---------------- | ---------- | ---------- | --------------------- | -------------------------- |
| caption          | string     | Polyline   | _null_                | Keterangan komponen        |
| width            | float      | 1          | _null_                | Ketebalan garis            |
| color            | string     | LightBlue  | _null_                | Warna garis                |
| style            | enum       | solid      | solid; dashed; dotted | Jenis garis                |
| begin_arrow_type | enum       | none       | arrow; square; circle | Bentuk ujung awal garis    |
| begin_arrow_size | float      | 0 (_auto_) | _null_                | Ukuran ujung awal garis\*  |
| end_arrow_type   | enum       | none       | arrow; square; circle | Bentuk ujung akhir garis   |
| end_arrow_size   | float      | 0 (_auto_) | _null_                | Ukuran ujung akhir garis\* |
...
\*) Minimal 2x dari nilai properti `width`
