...
Berikut contoh komponen peta `basemap`:

```xml
<basemap>
  <basemap>
    <caption>Spinal</caption>
    <url>https://{s}.tile.thunderforest.com/spinal-map/{z}/{x}/{y}.png?apikey={apiKey}</url>
    <api_key>l0r3m1p5umd0l0r51t4m3t</api_key>
    <attribution>&#xa9; Thunderforest</attribution>
    <max_zoom>22</max_zoom>
  </basemap>
</basemap>
```
...
| ------------- | ---------- | ---------- | ----------------------------------- |
| caption       | string     | Basemap    | Keterangan komponen                 |
